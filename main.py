...
from routes.routes_categorias import router as categorias_router
...
app.include_router(autenticacion_router,prefix='/api')
app.include_router(metodos_pago_router,prefix='/api')
app.include_router(categorias_router,prefix='/api')
app.include_router(domicilios_router,prefix='/api')
app.include_router(pedidos_router, prefix='/api')
app.include_router(detalles_carrito_router, prefix='/api')
app.include_router(detalles_pedido_router,prefix='/api')
app.include_router(envio_router,prefix='/api')
app.include_router(productos_router,prefix='/api')
app.include_router(checkout_router,prefix='/api')
app.include_router(pedido_consulta_router,prefix='/api')
